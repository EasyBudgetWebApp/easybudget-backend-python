...
class Transaction(models.Model):
    ...
    custom_user = models.ForeignKey(CustomUser, on_delete=models.CASCADE,
                                    null=True)  # It is impossible to add a non-nullable field 'custom_user' to transaction without specifying a default. Anyway all transactions will be always attrubuted to a user
